...
# from data_set import CLASS_INFO
...
def draw_bounding_box_on_image(image,
    ...
    #description_str = "Part number: {}\nStock on hand: {}\nDescription: {}".format(10506, 30, "Doll dog as Chrismas Present")
    ...
    for display_str in display_str_list[::-1]:
        ...
        # desp_width, desp_height = font.getsize(description_str)
        # draw.rectangle(
        #     [(right, text_bottom - 2 * margin), (right + desp_width,
        #                                                       text_bottom + 2 * desp_height)],
        #     fill=color)
        # draw.text(
        #     (right + margin, text_bottom - margin),
        #     description_str,
        #     fill='black',
        #     font=font_text)
